          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-16">
              <p className="text-xl lg:text-2xl font-bold text-black mb-2">
                Ejiro Amos Tafiri School of Design is currently on hold and would be back better in February 2021.
              </p>
            </div>

            <div className="space-y-8 text-base lg:text-lg text-gray-800 leading-relaxed max-w-5xl">
              <p>
                Ejiro Amos Tafiri School of Design (EATSDN) is a home ground for fashion industry hopefuls.
                We offer an invasive practical real world sphere of learning while making all efforts to provide you only useful, necessary and practical information at the highest instructional levels.
              </p>
              <p>
                Ejiro Amos Tafiri educates and trains students with a knowledge base that will set you ahead. We have a goal to build a generation of educated, seasoned and professional fashion entrepreneurs each student per time
              </p>
              <p>
                At EATSDN You will find that members of our faculty led by the Founder and Creative Director Ejiro Amos Tafiri; continue to work in the aspects they train students in. Our industry connected and academically trained tutors have experienced first hand the benefits of fashion education and devote to lending a hand to hone your skills. This is the foundation we are building on.
              </p>
            </div>
          </div>
        </motion.section>
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-base lg:text-lg text-gray-800 leading-relaxed mb-16 max-w-5xl">
              We have a responsive curriculum and accelerated programs which can help you jump-start a career in fashion in Nigeria or anywhere else. With properly constructed outlines in addition to expertise in what and how we teach, your education is hands-on, interactive, relevant and will produce results.
            </p>
            ...
            <div className="space-y-16">
              ...
              <div>
                ...
                <div className="space-y-3 text-base lg:text-lg">
                  <p className="text-gray-800">
                    <span className="font-semibold">Course fee –</span> 270,000 naira (Payment can be made in two installments and it covers provision of starter kit)
                  </p>
                  <p className="text-gray-800">
                  ...
                  <div className="mt-8">
                    <p className="font-semibold text-black mb-4">Course outline includes:</p>
              ...
              <div>
                <p className="text-base lg:text-lg text-gray-800 mb-8">
                  As an alternative to the full Fashion Core course, we also offer single diploma courses in:
                </p>
                
                <div className="space-y-3 text-base lg:text-lg">
                  <p className="text-gray-800">Pattern Drafting (Beginner – 150,000 naira / Advanced – 200,000 naira)</p>
                  <p className="text-gray-800">Draping – 150,000 naira</p>
                  <p className="text-gray-800">Fashion business and Branding – 150,000 naira</p>
                  <p className="text-gray-800">Bespoke and Bridal wear – 150,000 naira</p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-4 text-base lg:text-lg text-gray-800">
              ...
              <p className="font-semibold text-black">
                <a href="tel:09099877279" className="hover:underline">09099877279</a> or{" "}
                <a href="mailto:sdn@ejiroamostairi.com" className="hover:underline">sdn@ejiroamostairi.com</a>
              </p>
              <p className="pt-4">
                Or visit us at 9A, Adeboye Solanke off Allen Avenue, Ikeja Lagos.
              </p>
            </div>
          </div>
        </motion.section>
