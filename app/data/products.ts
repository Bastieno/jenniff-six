...
export const products: Product[] = [
  ...
  // Male Products
  {
    ...
    price: 650,
    currency: "USD",
    description: "Traditional West African boubou with modern tailoring and premium embroidery details.",
    images: [
      "https://ejiroamostafiri.com/wp-content/uploads/2025/08/OS_7629-680x1020.jpg",
      "https://ext.same-assets.com/2272108455/1581875077.jpeg",
      "https://ext.same-assets.com/2272108455/395474336.jpeg",
    ...
    sizes: [
      { name: "S", measurements: { chest: 38, waist: 32, shoulder: 17, length: 60 }, available: true },
      { name: "M", measurements: { chest: 40, waist: 34, shoulder: 18, length: 61 }, available: true },
      { name: "L", measurements: { chest: 42, waist: 36, shoulder: 19, length: 62 }, available: true },
      { name: "XL", measurements: { chest: 44, waist: 38, shoulder: 20, length: 63 }, available: true },
      { name: "XXL", measurements: { chest: 46, waist: 40, shoulder: 21, length: 64 }, available: true },
    ],
    colors: [
      { name: "White", hex: "#FFFFFF", available: true },
    ...
    materials: ["100% Cotton", "Hand-embroidered details", "Premium finish"],
    careInstructions: ["Dry clean recommended", "Iron on medium heat", "Store hanging"],
    inStock: true,
    featured: true,
  },
  {
    id: "embroidered-kaftan-014",
    name: "Men's Embroidered Kaftan",
    category: "kaftan",
    gender: "male",
    collection: "SS25",
    price: 480,
    currency: "USD",
    description: "Elegant men's kaftan with intricate embroidery and comfortable fit for formal occasions.",
    images: [
      "https://ejiroamostafiri.com/wp-content/uploads/2025/08/OS_8299-680x1020.jpg",
      "https://ext.same-assets.com/2272108455/395474336.jpeg",
      "https://ejiroamostafiri.com/wp-content/uploads/2025/09/OS_8714.jpg",
    ...
    sizes: [
      { name: "M", measurements: { chest: 40, waist: 34, shoulder: 18, length: 58 }, available: true },
      { name: "L", measurements: { chest: 42, waist: 36, shoulder: 19, length: 59 }, available: true },
      { name: "XL", measurements: { chest: 44, waist: 38, shoulder: 20, length: 60 }, available: true },
      { name: "XXL", measurements: { chest: 46, waist: 40, shoulder: 21, length: 61 }, available: false },
    ],
    colors: [
      { name: "Cream", hex: "#FFFDD0", available: true },
    ...
    materials: ["Premium linen", "Embroidered details", "Breathable fabric"],
    careInstructions: ["Machine wash cold", "Hang to dry", "Low heat iron"],
    inStock: true,
    featured: false,
  },
  {
    id: "traditional-set-015",
    ...
    price: 720,
    currency: "USD",
    description: "Complete traditional set including top and matching trousers with contemporary styling.",
    images: [
      "https://ejiroamostafiri.com/wp-content/uploads/2025/08/E.A.T-PRODUCTS045-680x1020.jpg",
      "https://ext.same-assets.com/2272108455/1581875077.jpeg",
      "https://ejiroamostafiri.com/wp-content/uploads/2025/09/OS_8714.jpg",
    ...
    sizes: [
      { name: "S", measurements: { chest: 38, waist: 32, shoulder: 17, length: 52 }, available: true },
      { name: "M", measurements: { chest: 40, waist: 34, shoulder: 18, length: 52 }, available: true },
      { name: "L", measurements: { chest: 42, waist: 36, shoulder: 19, length: 53 }, available: true },
      { name: "XL", measurements: { chest: 44, waist: 38, shoulder: 20, length: 53 }, available: true },
    ],
    colors: [
      { name: "Royal Blue", hex: "#4169E1", available: true },
    ...
    materials: ["Cotton blend", "Traditional patterns", "Comfortable fit"],
    careInstructions: ["Dry clean only", "Store separately", "Avoid direct sunlight"],
    inStock: true,
    featured: true,
  },
  {
    id: "modern-classics-016",
    name: "Modern Classics Shirt",
    category: "classics",
    gender: "male",
    collection: "SS25",
    price: 350,
    currency: "USD",
    description: "Contemporary African-inspired shirt with classic tailoring and modern design elements.",
    images: [
      "https://ejiroamostafiri.com/wp-content/uploads/2025/08/TMWSTUDIOS20254100-680x1020.jpg",
      "https://ext.same-assets.com/2272108455/395474336.jpeg",
      "https://ejiroamostafiri.com/wp-content/uploads/2025/09/OS_8714.jpg",
    ...
    sizes: [
      { name: "S", measurements: { chest: 38, waist: 32, shoulder: 17, length: 30 }, available: true },
      { name: "M", measurements: { chest: 40, waist: 34, shoulder: 18, length: 31 }, available: true },
      { name: "L", measurements: { chest: 42, waist: 36, shoulder: 19, length: 32 }, available: true },
      { name: "XL", measurements: { chest: 44, waist: 38, shoulder: 20, length: 33 }, available: true },
    ],
    colors: [
      { name: "White", hex: "#FFFFFF", available: true },
    ...
    materials: ["100% Cotton", "Button-down style", "Breathable fabric"],
    careInstructions: ["Machine wash", "Tumble dry low", "Iron as needed"],
    inStock: true,
    featured: false,
  },
  {
    id: "luxury-boubou-017",
    name: "Luxury Embellished Boubou",
    category: "boubou",
    gender: "male",
    collection: "SS25",
    price: 890,
    currency: "USD",
    description: "Premium boubou with gold embellishments and intricate hand-sewn details for special occasions.",
    images: [
      "https://ejiroamostafiri.com/wp-content/uploads/2025/08/E.A.T-PRODUCTS036-680x1020.jpg",
      "https://ext.same-assets.com/2272108455/1581875077.jpeg",
      "https://ext.same-assets.com/2272108455/395474336.jpeg",
    ...
    sizes: [
      { name: "M", measurements: { chest: 40, waist: 34, shoulder: 18, length: 62 }, available: true },
      { name: "L", measurements: { chest: 42, waist: 36, shoulder: 19, length: 63 }, available: true },
      { name: "XL", measurements: { chest: 44, waist: 38, shoulder: 20, length: 64 }, available: true },
      { name: "XXL", measurements: { chest: 46, waist: 40, shoulder: 21, length: 65 }, available: false },
    ],
    colors: [
      { name: "Gold", hex: "#FFD700", available: true },
      { name: "Silver", hex: "#C0C0C0", available: true },
      { name: "Deep Blue", hex: "#00008B", available: true },
    ],
    materials: ["Premium silk", "Gold thread embroidery", "Luxury finish"],
    careInstructions: ["Professional clean only", "Store in garment bag", "Handle with care"],
    inStock: true,
    featured: true,
  },
];
